          ...
          <div class="card-body">
            <blockquote class="blockquote mb-0">
              <ul>
                ...
                <p>Link Akses Login: http://127.0.0.1:5000/login.</p>
                <ol>
                ...
                <!-- Halaman Data Barang -->
                <li><b>Halaman Data Barang</b></li>
                <p style="text-align: justify;">Digunakan untuk mengupload data barang mengupdate data barang dan menghapus data barang, lalu dapat menghapus seluruh data yang ada. halaman ini juga memuat hasil dari clustering yaitu pada kolom kategori, namun saat pertama kali upload data makan akan otomatis terisi tidak ada.
                </p>
                <p>Cara Upload Data :</p>
                <ol>
                  <li>Buka menu Data Barang</li>
                  <li>Klik Tambah Data</li>
                  <li>Masukkan data berupa file excel</li>
                  <li>Klik Simpan</li>
                </ol>
                <!-- Halaman Pengelompokan Data -->
                <li><b>Halaman Pengelompokan Data</b></li>
                <p style="text-align: justify;">Digunakan untuk melihat hasil clustering dan bentuk visualisasi dari sebelum clustering, sesudah clustering, dan silhouette, untuk memulai proses clustering cukup klik tombong mulai maka otomatis akan langsung melanjalankan proses clustering.
                </p>
              </ul>
            </blockquote>
          </div>
